...
mainCyclist.setCollider("rectangle",0,0,1337,1337);
mainCyclist.debug = false;
  
//set collider for mainCyclist

  
gameOver = createSprite(370,150);
...
function draw() {
  ...
  fill("skyBlue")  
  textSize(20);
  text("Press Up Arrow To Restart Your Game!!!",203,200);
